//! Analytical Hessian cross-check suite for `Jet2Vec`.
//!
...
fn test_hessian_x2y_plus_y3() {
    ...
    assert_abs_diff_eq!(h[[0, 0]], 4.0, epsilon = TOL);
    assert_abs_diff_eq!(h[[0, 1]], 2.0, epsilon = TOL);
    assert_abs_diff_eq!(h[[1, 0]], 2.0, epsilon = TOL);
    assert_abs_diff_eq!(h[[1, 1]], 12.0, epsilon = TOL);
}
...
fn test_hessian_sin_xy() {
    let x = Jet2Vec::variable(1.0, 0, 2);
    let y = Jet2Vec::variable(PI / 2.0, 1, 2);
    let f = (&x * &y).sin();
    ...
    assert_abs_diff_eq!(h[[0, 0]], expected_xx, epsilon = TOL);
    assert_abs_diff_eq!(h[[1, 1]], expected_yy, epsilon = TOL);
    assert_abs_diff_eq!(h[[0, 1]], expected_xy, epsilon = TOL);
    assert_abs_diff_eq!(h[[1, 0]], expected_xy, epsilon = TOL);
}
...
fn test_hessian_exp_x2_plus_y2() {
    let x = Jet2Vec::variable(0.5, 0, 2);
    let y = Jet2Vec::variable(0.5, 1, 2);
    let f = (&(&x * &x) + &(&y * &y)).exp();
    ...
    assert_abs_diff_eq!(h[[0, 0]], 3.0 * e, epsilon = TOL);
    assert_abs_diff_eq!(h[[1, 1]], 3.0 * e, epsilon = TOL);
    assert_abs_diff_eq!(h[[0, 1]], e, epsilon = TOL);
    assert_abs_diff_eq!(h[[1, 0]], e, epsilon = TOL);
}
...
fn test_hessian_x_minus_y_squared_log_x_plus_y() {
    ...
    assert_abs_diff_eq!(h[[0, 0]], h00, epsilon = TOL);
    assert_abs_diff_eq!(h[[1, 1]], h11, epsilon = TOL);
    assert_abs_diff_eq!(h[[0, 1]], h01, epsilon = TOL);
    assert_abs_diff_eq!(h[[1, 0]], h01, epsilon = TOL);
}
